                            ...
                            <div class="col-lg-12 col-md-4 col-sm-6 custom-pad-20">
                                <div class="tp-contact-info mb-40">
                                    ...
                                    <div class="tp-contact-info-text">
                                        ...
                                        <a href="tel:<?php echo $phone_raw; ?>"><?php echo htmlspecialchars($phone_text); ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-4 col-sm-6 custom-pad-20">
                                <div class="tp-contact-info mb-40">
                                    ...
                                    <div class="tp-contact-info-text">
                                        ...
                                        <a href="mailto:<?php echo $contact_email; ?>"><?php echo htmlspecialchars($contact_email); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tp-contact-form" style="background-color: #fff; padding: 30px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); border: 1px solid #eee;">
                            <form action="../submit-booking.php" method="POST">
                                ...
                                <div style="display: flex; background: #f0f2f5; padding: 4px; border-radius: 30px; margin-bottom: 20px; gap: 4px; border: 1px solid #e0e0e0;">
                                    ...
                                    <button type="button" onclick="location.href='../pages/career.php';" style="flex: 1; padding: 10px 8px; border: none; border-radius: 25px; font-size: 12px; font-weight: 700; cursor: pointer; background: transparent; color: #555; text-align: center; line-height: 1.2;">Looking for Job</button>
                                </div>
